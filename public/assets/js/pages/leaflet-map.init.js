...
// Working with popups
var popupmap = L.map('leaflet-map-popup').setView([-6.88677905798411, 107.61553897007866], 13);
...
L.marker([-6.88677905798411, 107.61553897007866]).addTo(popupmap)
    .bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();

L.circle([-6.88677905798411, 107.61553897007866], 500, {
     color: '#34c38f',
    fillColor: '#34c38f',
    fillOpacity: 0.3
